...
using MEL.Spectre.Ci.Renderers;
...
internal sealed class SpectreConsoleLoggerProvider : ILoggerProvider, ISupportExternalScope, IAsyncDisposable
{
        ...
        SpectreConsoleLoggerSuspension suspension)
    {
        ...
        var formatter = new EntryFormatter(template, _options.Theme, masker, _options.AllowMarkupInMessageTemplate, _options.MinimumInlineLevel, _options.EmbeddedAnsi, _options.MaskValuePatternsInMessageText);
    ...
    public void Dispose()
    {
        ...
        {
            try { System.Console.Error.WriteLine($"MEL.Spectre: dispose fault: {ex}"); } catch { }
        }
    }
